        ...
        <div className="about-container">
          ...
          <div className="about-story-grid">
            ...
            <p>
              ...
              <p>
                MW-Sensor also designs integrated circuits (ICs) and IP blocks for communication systems, including V2X technologies for autonomous vehicles. 
              </p>
            </p>
            </div> 
          </div>
         <div className="about-story-grid">
              ...
              <p>
                <p>
                We deliver final GDSII files and complete technical documentation based on RF CMOS and SiGe BiCMOS process technologies down to 28 nm, utilizing the official PDKs of leading global foundries such as TSMC, SMIC, IHP, and others.
                </p>
                <p>
          ...
          <div className="about-custom-offer">
            <div className="custom-offer-inner">
